...
<template>
  <section
    id="experience"
    class="py-24 md:py-32 bg-card/50 relative overflow-hidden"
  >
    <div
      class="hidden md:block absolute left-1/2 top-48 bottom-24 w-px bg-gradient-to-b from-transparent via-border to-transparent"
    />
    ...
    <div class="max-w-[1200px] mx-auto px-6 relative">
      <div class="text-center mb-16">
        ...
        <p class="text-muted-foreground text-lg max-w-2xl mx-auto">
          Un parcours marqué par des projets ambitieux et une évolution
          constante.
        </p>
      </div>
      ...
      <div class="relative">
        <div
          class="hidden md:flex absolute left-1/2 -translate-x-1/2 top-0 w-4 h-4 rounded-full bg-primary shadow-lg shadow-primary/50"
        />
        ...
        <div class="space-y-8 md:space-y-12">
          ...
          >
            <div
              class="group w-full bg-card border border-border rounded-2xl p-6 hover:border-primary/50 transition-all duration-300"
            >
        ...
        <div
          class="hidden md:flex absolute left-1/2 -translate-x-1/2 bottom-0 w-4 h-4 rounded-full bg-border"
        />
      </div>
    </div>
  </section>
